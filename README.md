...
MCH LITE ARENA向けに分離したGoエンジンです。本家全体や本家の完全再現版ではありません。ウォレット・課金・ログイン・本番サーバー・個人データは含みません。許可されたヒーロー画像と共通バトル素材・音声は `assets/` に収録しています。範囲は [素材一覧](docs/MEDIA.md) を参照してください。
